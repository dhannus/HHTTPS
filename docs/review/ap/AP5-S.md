...
**Begründung:** `apexDomainFromUrl` (server.js L3940-3949, wp-plugin L38-51) akzeptiert `http://…` und sogar nackte Hostnamen; die 400-Meldung lautet dennoch `homepage_url must be a valid HTTPS URL`. Die Homepage wird im Consent-Screen und in der Bestätigungs-Mail als Link ausgegeben.
